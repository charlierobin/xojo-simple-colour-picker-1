...
Begin DesktopWindow Window1
   ...
   Begin DesktopRectangle Rectangle4
      ...
      Width           =   100
   End
   Begin ContainerColourPicker ColourPicker
      AllowAutoDeactivate=   True
      AllowFocus      =   False
...
#tag WindowCode
	...
	#tag Note, Name = mouse move
		// System.DebugLog( x.ToString() + " " + y.ToString() )
		
		const dylib = "@executable_path/../Frameworks/libScreenSampler.dylib"
		
		declare function MyColorAtScreenCoordinate lib dylib ( x as Integer, y as Integer ) as Ptr
		
		x = x + self.Left
		
		y = y + self.Top
		
		var c as Ptr = MyColorAtScreenCoordinate( x, y )
		
		// System.DebugLog( str( c ) )
		...
		// System.DebugLog( r.ToString() + " " + g.ToString() + " " + b.ToString() )
		
		self.BackgroundColor = Color.RGB( r, g, b )
